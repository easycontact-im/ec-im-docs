...
<CardGroup cols={3}>
  ...
  <Card
    title="Prometheus"
    icon="fire"
    href="/configuration/integrations/prometheus"
  >
  ...
  <Card
    title="Grafana"
    icon="chart-line"
    href="/configuration/integrations/grafana"
  >
  ...
  <Card
    title="AppDynamics"
    icon="a"
    href="/configuration/integrations/appdynamics"
  >
  ...
  <Card
    ...
    icon="code"
    href="/configuration/integrations/custom"
  >
