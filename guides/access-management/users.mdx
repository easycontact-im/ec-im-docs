...
For programmatic user management, see our [API Documentation](/api-reference/access-management/users).

<CardGroup cols={2}>
  <Card title="List Users" icon="list" href="/api-reference/access-management/users#list-users">
    GET /api/v1/iam/{tenantId}/users
  </Card>
  <Card title="Invite User" icon="user-plus" href="/api-reference/access-management/users#invite-user">
    POST /api/v1/iam/{tenantId}/invites
  </Card>
  <Card title="Update User" icon="pen" href="/api-reference/access-management/users#update-user">
    PUT /api/v1/iam/{tenantId}/users/{userId}
  </Card>
  <Card title="Remove User" icon="user-minus" href="/api-reference/access-management/users#remove-user">
    DELETE /api/v1/iam/{tenantId}/users/{userId}
  </Card>
</CardGroup>
